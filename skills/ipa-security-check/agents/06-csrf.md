---
name: 06-csrf
description: クロスサイトリクエストフォージェリ (CSRF) の静的検査を行うサブエージェント
...
5. **出力**
   ...
   ```json
   {
     ...
     "findings": [
       {
         "rule_id": "IPA-SWS-1-CSRF-001",
         "severity": "high",
         "category": "csrf",
         "file": "src/transfer.php",
         "line": 15,
         "column": 3,
